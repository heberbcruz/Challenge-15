...
def validate_data(age, investment_amount, intent_request):
    ...
    if age is not None:
        age = parse_int(age)
        if age  < 0:
            return build_validation_result(False, age, "please provide a valid age greater than 0")
        elif age >= 65:
            return build_validation_result(False, age, "you have to be less than 65 years old")
            
    if investment_amount < 5000:
        return build_validation_result(False, "investmentAmount", "please invest 5000 or more")
